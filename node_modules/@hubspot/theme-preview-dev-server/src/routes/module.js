...
const buildModuleRouteHandler = (sessionInfo) => {
    ...
    return async (req, res) => {
        ...
        try {
            const response = await (0, designManager_js_1.fetchModulesByPath)(accountId, calculatedPath);
            customWidgetInfo = response.data;
        }
        catch (err) {
        ...
        const { data: result } = await http_1.http.get(accountId, {
