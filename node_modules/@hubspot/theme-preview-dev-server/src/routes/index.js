...
const getModulesForDisplayToUser = async (sessionInfo) => {
    ...
    try {
        const { data } = await (0, designManager_js_1.fetchPreviewModules)(accountId, sessionToken);
        const modulePaths = data
            .objects
...
const getTemplatesForDisplayToUser = async (sessionInfo) => {
    const { accountId, sessionToken } = sessionInfo;
    try {
        const { data } = await (0, designManager_js_1.fetchPreviewTemplates)(accountId, sessionToken);
