...
export function cliAccountNamePrompt(defaultName) {
    return promptUser(getCliAccountNamePromptConfig(defaultName));
}
export function hubspotAccountNamePrompt({ accountType, currentPortalCount = 0, }) {
    const isDevelopmentSandbox = accountType === HUBSPOT_ACCOUNT_TYPES.DEVELOPMENT_SANDBOX;
