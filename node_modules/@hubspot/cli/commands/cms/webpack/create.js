...
async function handler(args) {
    ...
    try {
        ...
        uiLogger.error(commands.cms.subcommands.webpack.subcommands.create.errors.unusablePath(argsToPass.dest));
        logError(e);
        return;
    }
    try {
...
function webpackCreateBuilder(yargs) {
    yargs.positional('dest', {
        describe: commands.cms.subcommands.webpack.subcommands.create.positionals.dest,
        type: 'string',
    });
    return yargs;
}
const builder = makeYargsBuilder(webpackCreateBuilder, command, describe, {
    useGlobalOptions: true,
    useConfigOptions: true,
});
const webpackCreateCommand = {
    command,
    describe,
    builder,
    handler,
