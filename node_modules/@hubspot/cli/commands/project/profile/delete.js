...
async function handler(args) {
    ...
    if (targetAccountId) {
        ...
        try {
            const fetchProjectResponse = await fetchProject(targetAccountId, projectConfig.name);
...
const builder = makeYargsBuilder(projectProfileDeleteBuilder, command, describe, {
