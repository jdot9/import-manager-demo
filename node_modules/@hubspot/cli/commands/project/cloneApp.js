...
import { isAppDeveloperAccount, isUnifiedAccount, } from '../../lib/accountTypes.js';
...
async function handler(args) {
    ...
    await trackCommandMetadataUsage('clone-app', { step: 'STARTED' }, derivedAccountId);
    try {
    ...
    await trackCommandMetadataUsage('clone-app', { successful: true }, derivedAccountId);
    process.exit(EXIT_CODES.SUCCESS);
}
...
const builder = makeYargsBuilder(cloneAppBuilder, command, describe, {
