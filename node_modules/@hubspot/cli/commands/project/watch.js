...
async function handleBuildStatus(accountId, projectName, buildId) {
    ...
    if (isAutoDeployEnabled && deployStatusTaskLocator) {
        await pollDeployStatus(accountId, projectName, Number(deployStatusTaskLocator.id), buildId);
    }
...
const builder = makeYargsBuilder(projectWatchBuilder, command, describe, {
