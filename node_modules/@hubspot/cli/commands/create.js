...
const describe = uiDeprecatedTag(commands.create.describe(SUPPORTED_ASSET_TYPES) +
    ' Please use the create commands in `hs cms` instead.', false);
async function handler(args) {
    ...
    if (!assetType || !assets[assetType]) {
        uiLogger.error(commands.create.errors.unsupportedAssetType(assetType, SUPPORTED_ASSET_TYPES));
        return;
    }
