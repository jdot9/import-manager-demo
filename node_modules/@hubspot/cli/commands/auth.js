...
const builder = makeYargsBuilder(authBuilder, command, commands.auth.verboseDescribe(PERSONAL_ACCESS_KEY_AUTH_METHOD.value, DEFAULT_HUBSPOT_CONFIG_YAML_FILE_NAME), {
