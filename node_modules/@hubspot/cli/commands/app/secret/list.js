...
async function handler(args) {
    ...
    if (appSecrets.length === 0) {
        uiLogger.log('');
        uiLogger.log(commands.app.subcommands.secret.subcommands.list.errors.noSecrets);
    }
    else {
        uiLogger.log('');
        uiLogger.log(commands.app.subcommands.secret.subcommands.list.success(appSecretApp.name));
...
function listAppSecretBuilder(yargs) {
    ...
    yargs.example('list --app=1234567890', commands.app.subcommands.secret.subcommands.list.example);
    return yargs;
}
const builder = makeYargsBuilder(listAppSecretBuilder, command, describe, {
