...
function createPerRenderTreeLoadResource(renderID, innerTree, renderOptions) {
  ...
  console.log("createPerRenderTreeLoadResource", renderID, resource);
  if (resource) {
    return resource;
  }
...
function RenderTreeSeparately({
  ...
  console.log("hitrenderTreeSeperately", import.meta.env.SSR);
  ...
  console.log("renderTreeSeperately", html, wrapperID);
  return /* @__PURE__ */ jsx(
    WrapperElement,
    {
      "data-hs-island": true,
